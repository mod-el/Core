...
<p>
	...
	if ($m->new_version) { ?>
        ...
        <a href="#" onclick="event.stopPropagation(); updateModule('<?= $m->folder_name ?>'); return false"> update </a>]<?php } elseif ($m->corrupted) { ?>
        <b style="color: #F00">Edited!</b> [
        <a href="#" onclick="event.stopPropagation(); updateModule('<?= $m->folder_name ?>'); return false"> restore </a>]
        <br/><?php }
	?>
</p>
