...
<p>
	<?php
	if($m->new_version){ ?><b style="color: #0C0">New version: <?=$m->new_version?></b> [<a href="#" onclick="event.stopPropagation(); updateModule('<?=$m->folder_name?>'); return false"> update </a>]<?php }
